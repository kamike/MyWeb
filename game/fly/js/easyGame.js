...
zfj.extend({
    ...
    startReady: function() {
        ...
        this.kz.update = function() {
            if (!window.eee) console.log(zfj)
                window.eee = 1;
            console.log(zfj.fj.y)
            this.y = zfj.canHeight - 2*this.h
        },
        ...
        this.mainlayer.push(this.kz, this.fj_yy, this.fj),
